...
class ContactRepository:
    ...
    async def get_contact_by_id(self, contact_id: int) -> Union[Contact, None]:
    ...
    async def update_contact(self, contact_id: int, body: ContactUpdate) -> Union[Contact, None]:
    ...
    async def remove_contact(self, contact_id: int) -> Union[Contact, None]:
        contact = await self.get_contact_by_id(contact_id)
        if contact:
